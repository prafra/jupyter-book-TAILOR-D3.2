...
While other aspects of ethics and trustworthiness, such as [PROVA](../Privacy_and_Data_Governance/Privacy_and_Data_Governance) {doc}`../Privacy_and_Data_Governance/Privacy_and_Data_Governance`, are not novel concepts, and a lot of scientific literature has been explored on these topics, the study of explainability is a new challenge.
